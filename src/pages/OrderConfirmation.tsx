      ...
      <div className="flex flex-col items-center justify-center px-6 pt-16 pb-8 text-center" dir="rtl">
        ...
        <div className="bg-card rounded-xl p-4 shadow-sm w-full mb-4 animate-fade-in-up stagger-3">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <button className="w-8 h-8 bg-primary/10 rounded-lg flex items-center justify-center active:scale-95 transition-transform">
        ...
        <div className="bg-card rounded-xl p-4 shadow-sm w-full space-y-3 mb-4 animate-fade-in-up stagger-4">
          <div className="flex justify-between text-sm">
            ...
            <span className="font-bold">SAR 493.63</span>
          </div>
          <div className="flex justify-between text-sm">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span className="font-semibold">2-4 أيام عمل</span>
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-muted-foreground">العنوان</span>
            <span className="font-semibold text-left">صنعاء، شارع الستين</span>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl p-4 shadow-sm w-full mb-6 animate-fade-in-up stagger-5">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 space-y-6">
              <div>
                <p className="text-sm font-bold text-success">تم تأكيد الطلب</p>
                <p className="text-xs text-muted-foreground">الآن</p>
              </div>
              <div>
                <p className="text-sm font-semibold text-muted-foreground">قيد التجهيز</p>
        ...
        <div className="w-full space-y-2">
          <button
            onClick={() => navigate("/order-tracking/514892")}
          ...
          <button
            onClick={() => navigate("/")}
            className="w-full border-2 border-primary text-primary font-bold text-sm py-3.5 rounded-xl active:scale-[0.97] transition-transform flex items-center justify-center gap-2"
          >
