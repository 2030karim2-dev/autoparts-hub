...
const orders: Order[] = [
  {
    id: "ORD-1024", customer: "أحمد محمد", customerType: "عادي", phone: "771234567",
    items: [
      { name: "بواجي NGK إيريديوم", sku: "NGK-IR-5", qty: 2, price: 90 },
      { name: "فلتر هواء تويوتا", sku: "FLT-AIR-TC", qty: 1, price: 50 },
      { name: "فلتر زيت بوش", sku: "BSH-OIL-03", qty: 1, price: 40 },
    ],
    total: 310, status: "جديد", paymentMethod: "كاش", paymentStatus: "مؤكد",
    date: "2026-04-01", city: "صنعاء", address: "شارع حدة، بجوار مسجد الصالح", deliveryFee: 40,
    timeline: [
      { status: "جديد", date: "2026-04-01 10:30", note: "تم استلام الطلب" },
    ]
  },
  {
    id: "ORD-1023", customer: "ورشة الأمين", customerType: "ورشة", phone: "773456789",
    items: [
      { name: "تيل فرامل سيراميك", sku: "BRK-CER-01", qty: 4, price: 100 },
      { name: "هوبات فرامل خلفية", sku: "BRK-DSC-R", qty: 2, price: 150 },
      { name: "مساعدات KYB", sku: "KYB-F-001", qty: 2, price: 250 },
    ],
    total: 1600, status: "قيد الشحن", paymentMethod: "تحويل صرافة", paymentStatus: "بانتظار التأكيد",
    exchange: "الكريمي", date: "2026-04-01", city: "تعز", address: "شارع جمال، قرب دوار المطار", deliveryFee: 50,
    timeline: [
      { status: "جديد", date: "2026-04-01 08:00" },
      { status: "قيد المعالجة", date: "2026-04-01 10:00", note: "تم تجهيز الطلب" },
      { status: "قيد الشحن", date: "2026-04-02 09:00", note: "تم تسليم الشحنة للسائق" },
    ]
  },
  {
    id: "ORD-1022", customer: "وزارة النقل", customerType: "حكومي", phone: "771112233",
    items: [
      { name: "فلتر هواء تويوتا", sku: "FLT-AIR-TC", qty: 10, price: 50 },
      { name: "فلتر زيت بوش", sku: "BSH-OIL-03", qty: 10, price: 40 },
      { name: "بواجي NGK إيريديوم", sku: "NGK-IR-5", qty: 20, price: 90 },
    ],
    total: 2700, status: "مكتمل", paymentMethod: "حساب صرافة", paymentStatus: "مؤكد",
    exchange: "العمقي", date: "2026-03-31", city: "عدن", address: "كريتر، شارع الملكة أروى", deliveryFee: 0,
    notes: "طلب حكومي - مطلوب فاتورة رسمية",
    timeline: [
      { status: "جديد", date: "2026-03-31 08:00" },
      { status: "قيد المعالجة", date: "2026-03-31 09:00" },
      { status: "قيد الشحن", date: "2026-03-31 14:00" },
      { status: "مكتمل", date: "2026-04-02 11:00", note: "تم التسليم والتوقيع" },
    ]
  },
  {
    id: "ORD-1021", customer: "تجارة العولقي", customerType: "جملة", phone: "772233445",
    items: [
      { name: "تيل فرامل سيراميك", sku: "BRK-CER-01", qty: 25, price: 85 },
      { name: "فلتر هواء تويوتا", sku: "FLT-AIR-TC", qty: 50, price: 42 },
    ],
    total: 4225, status: "قيد المعالجة", paymentMethod: "تحويل صرافة", paymentStatus: "بانتظار التأكيد",
    exchange: "البسيري", date: "2026-03-31", city: "صنعاء", address: "شارع 26 سبتمبر", deliveryFee: 0,
    notes: "عميل جملة - خصم 15%",
    timeline: [
      { status: "جديد", date: "2026-03-31 14:00" },
      { status: "قيد المعالجة", date: "2026-04-01 08:00", note: "جاري تجهيز الطلب" },
    ]
  },
  {
    id: "ORD-1020", customer: "علي حسين", customerType: "عادي", phone: "775566778",
    items: [{ name: "شمعات LED هيونداي", sku: "LED-HY-01", qty: 1, price: 180 }],
    total: 180, status: "ملغي", paymentMethod: "كاش", paymentStatus: "مرفوض",
    date: "2026-03-30", city: "إب", address: "شارع العدين", deliveryFee: 45,
    timeline: [
      { status: "جديد", date: "2026-03-30 16:00" },
      { status: "ملغي", date: "2026-03-30 18:00", note: "ألغي بطلب من العميل" },
    ]
  },
  {
    id: "ORD-1019", customer: "مركز الوفاء", customerType: "ورشة", phone: "779988776",
    items: [
      { name: "سير مروحة تويوتا", sku: "BLT-FN-TC", qty: 3, price: 35 },
      { name: "بواجي NGK إيريديوم", sku: "NGK-IR-5", qty: 6, price: 90 },
    ],
    total: 645, status: "جديد", paymentMethod: "تحويل صرافة", paymentStatus: "بانتظار التأكيد",
    exchange: "الكريمي", date: "2026-03-30", city: "الحديدة", address: "شارع صنعاء", deliveryFee: 60,
    timeline: [
      { status: "جديد", date: "2026-03-30 11:00" },
    ]
  },
];
...
const timelineIcons: Record<string, any> = {
  "جديد": Clock, "قيد المعالجة": Package, "قيد الشحن": Truck, "مكتمل": CheckCircle, "ملغي": XCircle,
};
    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <Card>
            <CardContent className="p-3 text-center">
              ...
              <p className="text-lg font-bold text-foreground">{statusCounts["جديد"] + statusCounts["قيد المعالجة"]}</p>
              <p className="text-[10px] text-muted-foreground">بانتظار المعالجة</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-3 text-center">
              <Truck className="h-5 w-5 text-purple-600 mx-auto mb-1" />
              <p className="text-lg font-bold text-foreground">{statusCounts["قيد الشحن"]}</p>
              <p className="text-[10px] text-muted-foreground">قيد الشحن</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-3 text-center">
              <CreditCard className="h-5 w-5 text-orange-600 mx-auto mb-1" />
              <p className="text-lg font-bold text-foreground">{orders.filter(o => o.paymentStatus === "بانتظار التأكيد").length}</p>
              <p className="text-[10px] text-muted-foreground">بانتظار تأكيد الدفع</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="flex gap-2 overflow-x-auto scrollbar-hide pb-1">
          <Button variant={statusFilter === "الكل" ? "default" : "outline"} size="sm" className="text-xs shrink-0" onClick={() => setStatusFilter("الكل")}>
            الكل ({orders.length})
          </Button>
          {statuses.map((s) => (
            <Button key={s} variant={statusFilter === s ? "default" : "outline"} size="sm" className="text-xs shrink-0" onClick={() => setStatusFilter(s)}>
              {s} ({statusCounts[s]})
            </Button>
          ))}
        </div>
        ...
        <Card>
          <CardContent className="p-3">
            <div className="relative">
              ...
              <Input placeholder="بحث برقم الطلب أو اسم العميل..." value={search} onChange={(e) => setSearch(e.target.value)} className="pr-9 h-9 text-sm" />
            </div>
          </CardContent>
        </Card>
            ...
            {selectedOrder && (
              <div className="space-y-4">
                ...
                <div className="rounded-lg border border-border overflow-hidden">
                  <div className="bg-muted/50 px-3 py-2">
                    <p className="text-xs font-semibold text-foreground flex items-center gap-1.5">
                      <Package className="h-3.5 w-3.5" /> المنتجات ({selectedOrder.items.length})
                    </p>
                  </div>
                    ...
                    {selectedOrder.items.map((item, i) => (
                      <div key={i} className="flex items-center justify-between p-3">
                        ...
                        <div className="text-left">
                          <p className="text-sm font-semibold text-foreground">{(item.qty * item.price).toLocaleString()} ر.س</p>
                          <p className="text-[10px] text-muted-foreground">{item.qty} × {item.price} ر.س</p>
                        </div>
                      </div>
                    ))}
                  </div>
                  <div className="bg-muted/30 px-3 py-2 space-y-1">
                    <div className="flex justify-between text-xs text-muted-foreground">
                      <span>المنتجات</span>
                      <span>{(selectedOrder.total - selectedOrder.deliveryFee).toLocaleString()} ر.س</span>
                    </div>
                    <div className="flex justify-between text-xs text-muted-foreground">
                      <span>التوصيل</span>
                      <span>{selectedOrder.deliveryFee > 0 ? `${selectedOrder.deliveryFee} ر.س` : "مجاني"}</span>
                    </div>
                    <div className="flex justify-between text-sm font-bold text-foreground pt-1 border-t border-border">
                      <span>الإجمالي</span>
                      <span>{selectedOrder.total.toLocaleString()} ر.س</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <Textarea placeholder="أضف ملاحظة على الطلب..." className="text-sm" rows={2} />
                </div>
